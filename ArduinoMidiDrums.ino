...
#define LCYM_THRESHOLD 50
#define RCYM_THRESHOLD 50
#define KICK_THRESHOLD 50
#define START_SLOT 0     //first analog slot of piezos

//MIDI note defines for each trigger
// definitions from http://computermusicresource.com/GM.Percussion.KeyMap.html
#define SNARE_NOTE 50 // cymbal, blue
#define LTOM_NOTE 35 //
#define RTOM_NOTE 35 //D2 left Tom , green 
#define LCYM_NOTE 57 // crash cyball, red
#define RCYM_NOTE 35 // 
#define KICK_NOTE 38 // snare, yellow
...
{
//  Serial.print("v:");
//  Serial.println(String(midiVelocity));
